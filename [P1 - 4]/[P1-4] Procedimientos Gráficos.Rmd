...
|  Opción |  Descripción |
|:-:|:----------------------------------:|
|  `add=FALSE`   | si es TRUE superpone el gra ́fico en el ya existente (si existe)   |
...
| `xlim=`, `ylim=`  | especifica los l ́ımites inferiores y superiores de los ejes; por ejemplo con `xlim=c(1, 10)` o `xlim=range(x)`  |
