...
author: 
- name: VMO
  affiliation: Instituto de Fomento Pesquero
...
- Ahora, obtén una muestra de 10 números entre 1 y 20, SIN REEMPLAZO. Para hacerlo, simplementre elimina el argumento `replace`.
